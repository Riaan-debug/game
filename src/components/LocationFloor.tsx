...
export function LocationFloor({ floorColor, rugColor, buildMode, onFloorClick }: LocationFloorProps) {
  ...
  return (
    <group>
      <mesh rotation={[-Math.PI / 2, 0, 0]} receiveShadow onPointerDown={handleFloorPointerDown}>

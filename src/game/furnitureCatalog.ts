...
export const FURNITURE_CATALOG: FurnitureCatalogItem[] = [
  { id: 'bed', name: 'Bed', category: 'bedroom', footprint: [3.6, 2.4], height: 0.7, color: '#5f7ab8', interaction: 'sleep', approachOffset: [0.6, 0.6] },
  ...
  { id: 'chair', name: 'Chair', category: 'seating', footprint: [0.55, 0.55], height: 0.9, color: '#8b6340', interaction: 'sit', approachOffset: [0, 0.45] },
  { id: 'couch', name: 'Couch', category: 'seating', footprint: [2.0, 0.9], height: 0.85, color: '#6d7f8b', interaction: 'sit', approachOffset: [0, 0.65] },
  ...
  { id: 'desk', name: 'Desk', category: 'tables', footprint: [1.2, 0.7], height: 0.78, color: '#7a6048' },
